...
def aussprache_trainer(target, path_to_audio, model, device, use_cuda):
    os.environ['overallscore'] = "0"
    ...
    class Hauptteil(Preparation):
        ...
        def google_pred(self, path):
            ...
            with audiofile as source:
                ...
                try:
                    ...
                    raise Exception("Google hat deinen Satz nicht verstanden")
                if google_pred:
        ...
        def IBM_pred(self):
            ...
            try:
                ...
                raise Exception("IBM hat deinen Satz nicht verstanden")
    ...
    Hauptteil(target, path_to_audio, model, device, use_cuda)
